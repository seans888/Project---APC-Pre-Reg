...
//****************************************************************************************
require 'path.php';
init_cobalt('View dept');

$page_title       = 'ListView: %%';
$db_subclass      = 'dept';
$html_subclass    = 'dept_html';
...
$add_link         = 'Add dept';
$edit_link        = 'Edit dept';
$delete_link      = 'Delete dept';
$view_link        = 'View dept';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_dept.php';
$edit_page        = 'edit_dept.php';
$delete_page      = 'delete_dept.php';
$view_page        = 'detailview_dept.php';
$csv_page         = 'csv_dept.php';
$report_page      = 'reporter_dept.php';
