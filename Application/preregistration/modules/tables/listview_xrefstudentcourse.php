...
$page_title       = 'ListView: Xrefstudentcourse';
$db_subclass      = 'xrefstudentcourse';
$html_subclass    = 'xrefstudentcourse_html';
$arr_pkey_name    = array('student_id','course','term_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add xrefstudentcourse';
$edit_link        = 'Edit xrefstudentcourse';
$delete_link      = 'Delete xrefstudentcourse';
$view_link        = 'View xrefstudentcourse';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_xrefstudentcourse.php';
$edit_page        = 'edit_xrefstudentcourse.php';
$delete_page      = 'delete_xrefstudentcourse.php';
$view_page        = 'detailview_xrefstudentcourse.php';
$csv_page         = 'csv_xrefstudentcourse.php';
$report_page      = 'reporter_xrefstudentcourse.php';
