...
//****************************************************************************************
require 'path.php';
init_cobalt('Add xrefstudentschedule');
...
if(xsrf_guard())
{
    ...
    if($_POST['btn_submit'])
    {
        ...
        if($dbh_xrefstudentschedule->check_uniqueness($arr_form_data)->is_unique)
        {
        ...
        if($message=="")
        {
            $dbh_xrefstudentschedule->add($arr_form_data);
...
$html->draw_header('Add Xrefstudentschedule', $message, $message_type);
