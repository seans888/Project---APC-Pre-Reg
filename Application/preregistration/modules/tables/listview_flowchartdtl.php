...
//****************************************************************************************
require 'path.php';
init_cobalt('View flowchartdtl');

$page_title       = 'ListView: Flowchartdtl';
$db_subclass      = 'flowchartdtl';
$html_subclass    = 'flowchartdtl_html';
$arr_pkey_name    = array('flow_dtl_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add flowchartdtl';
$edit_link        = 'Edit flowchartdtl';
$delete_link      = 'Delete flowchartdtl';
$view_link        = 'View flowchartdtl';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_flowchartdtl.php';
$edit_page        = 'edit_flowchartdtl.php';
$delete_page      = 'delete_flowchartdtl.php';
$view_page        = 'detailview_flowchartdtl.php';
$csv_page         = 'csv_flowchartdtl.php';
$report_page      = 'reporter_flowchartdtl.php';
