...
//****************************************************************************************
require 'path.php';
init_cobalt('View flowcharthdr');

$page_title       = 'ListView: Flowcharthdr';
$db_subclass      = 'flowcharthdr';
$html_subclass    = 'flowcharthdr_html';
$arr_pkey_name    = array('flow_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add flowcharthdr';
$edit_link        = 'Edit flowcharthdr';
$delete_link      = 'Delete flowcharthdr';
$view_link        = 'View flowcharthdr';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_flowcharthdr.php';
$edit_page        = 'edit_flowcharthdr.php';
$delete_page      = 'delete_flowcharthdr.php';
$view_page        = 'detailview_flowcharthdr.php';
$csv_page         = 'csv_flowcharthdr.php';
$report_page      = 'reporter_flowcharthdr.php';
