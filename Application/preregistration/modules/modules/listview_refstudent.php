...
//****************************************************************************************
require 'path.php';
init_cobalt('View refstudent');

$page_title       = 'ListView: Refstudent';
$db_subclass      = 'refstudent';
$html_subclass    = 'refstudent_html';
$arr_pkey_name    = array('student_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add refstudent';
$edit_link        = 'Edit refstudent';
$delete_link      = 'Delete refstudent';
$view_link        = 'View refstudent';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_refstudent.php';
$edit_page        = 'edit_refstudent.php';
$delete_page      = 'delete_refstudent.php';
$view_page        = 'detailview_refstudent.php';
$csv_page         = 'csv_refstudent.php';
$report_page      = 'reporter_refstudent.php';
