...
//****************************************************************************************
require 'path.php';
init_cobalt('View addsubject');

$page_title       = 'ListView: Addsubject';
$db_subclass      = 'addsubject';
$html_subclass    = 'addsubject_html';
$arr_pkey_name    = array();
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add addsubject';
$edit_link        = 'Edit addsubject';
$delete_link      = 'Delete addsubject';
$view_link        = 'View addsubject';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_addsubject.php';
$edit_page        = 'edit_addsubject.php';
$delete_page      = 'delete_addsubject.php';
$view_page        = 'detailview_addsubject.php';
$csv_page         = 'csv_addsubject.php';
$report_page      = 'reporter_addsubject.php';
