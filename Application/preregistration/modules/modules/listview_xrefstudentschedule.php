...
$page_title       = 'ListView: Xrefstudentschedule';
$db_subclass      = 'xrefstudentschedule';
$html_subclass    = 'xrefstudentschedule_html';
$arr_pkey_name    = array('subject_offering_id','student_id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add xrefstudentschedule';
$edit_link        = 'Edit xrefstudentschedule';
$delete_link      = 'Delete xrefstudentschedule';
$view_link        = 'View xrefstudentschedule';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_xrefstudentschedule.php';
$edit_page        = 'edit_xrefstudentschedule.php';
$delete_page      = 'delete_xrefstudentschedule.php';
$view_page        = 'detailview_xrefstudentschedule.php';
$csv_page         = 'csv_xrefstudentschedule.php';
$report_page      = 'reporter_xrefstudentschedule.php';
